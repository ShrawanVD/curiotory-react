        ...
        <div>
          ...
          <div className="cover-page">
            {/* <div className="mascot-cover">
              <img src="./images/mascot/curo2.gif" />
            </div> */}
              ...
              <div className="learn-foriegn-lang-container">
                <div className="container1">
                  ...
                  <div className="container-cards">
                    ...
                    <p>
                      Gain a deeper cultural perspective of diverse cultures and
                      be more empathetic.
                    </p>
                  </div>
                </div>
            ...
            <div className="foreign-lang-container">
              <div className="foreign-lang-left-container">
                <h4>
                  ...
                  maximize their potential for success on the path they choose.
                </h4>
                <br />
                <p>
                  However, like any life-changing skill, learning new languages
                  is a journey that demands proper guidance and expertise. Else,
                  you’ll face barriers that can stop you dead in your tracks.
                  These include:
                </p>
              </div>
          ...
          <div className="various-lang">
            <div
              ...
              style={{
                backgroundImage: "url('./images/mascot/20imagemascot.png')",
            ...
            >
              <div className="foreign-lang">
                <h1>
                  11 <span style={{ color: "#ff7439" }}>foreign language</span>{" "}
              ...
              <div className="foreign-lang-content">
                ...
                <div className="asian-lang-section">
                  <div className="asian-lang-left-part">
                    <h2>
                      Asian <span style={{ color: "#2f327d" }}>Languages</span>
                    </h2>
                  </div>
