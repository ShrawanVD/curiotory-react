             ...
             <div className={newcover.wonderingContainer}>
               ...
               <div className="container1">
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 1.png" />
                   <h3>Academic Excellence</h3>
                   <p>
                     Ace exams like SAT & GRE and outperform the rest in school/college
                     interviews.
                   </p>
                 </div>
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 2.png" />
                   <h3>Dream Careers</h3>
                   <p>
                 ...
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 3.png" />
                 ...
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 4.png" />
                 ...
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 5.png" />
                 ...
                 <div className="container-cards">
                   <img width="97" height="74" src="/Index/learn foreign - 6.png" />
                   <h3>Cultural Empathy</h3>
                   <p>
                     Gain a deeper cultural perspective of diverse cultures and be more
                     empathetic.
                   </p>
                 </div>
               </div>
               ...
               <div className="foreign-lang-container">
                 <div className="foreign-lang-left-container">
                   <h4>
                     ...
                     limitations such as limited expertise, fixed schedules, lack of
                     flexibility, and constraints on cultural immersion. In contrast,
                     online learning offers global access to expertise, flexible
                     scheduling, anytime-anywhere accessibility, and rich cultural
                     integration. <br />
                   ...
                   <p>
                     ...
                     benefits of flexibility, accessibility, and cultural immersion.
                   </p>
                 </div>
                 <div className="foreign-lang-right-container">
                   <div className="foreign-lang-sub-contianer">
                     ...
                     />
                     <p>
                       Generic, one-size-fits-all curriculum instead of personalized
                       courses
                     </p>
                   </div>
                   <div className="foreign-lang-sub-contianer">
                   ...
                   <div className="foreign-lang-sub-contianer">
                     ...
                     />
                     <p>
                       Outdated remote technology set-ups that cause learning delays &
                       disruptions
                     </p>
                   </div>
                 </div>
             ...
             <div>
               <div className={newcover.foreignContainer}>
                 <h2 className={newcover.foreignTitle}>
                   11{" "}
                   <span className={newcover.foreignHighlight}>foreign language</span>{" "}
                 ...
                 <p className={newcover.foreignSubtitle}>
                   ...
                   journey that demands proper guidance and expertise. Curiotory can
               ...
               >
                   ...
                   <div className="swiper-slide">
                     ...
                     <div className="reviews">
                       <p>
                         ...
                         learn a foreign language. So, I got to learn from Priya
                         Nagpal, my Korean tutor at Curiotory. And what an experience
                         it has been! I like everything about the course.I would
                         recommend Curiotory and Priya Nagpal to everyone!
                       </p>
                     </div>
                   </div>
                 </SwiperSlide>
                 <SwiperSlide>
                   <div className="swiper-slide">
                     ...
                     <div className="designation">Spanish B1 - Akola Maharashtra</div>
                     <div className="reviews">
                       <p>
                         ...
                         helped me a lot too. Moreover, the platform is very organized
                         and systematic. It was overall a great learning experience.”
                       </p>
                     </div>
                   </div>
                 </SwiperSlide>
                   ...
                   <div className="swiper-slide">
                     ...
                     <div className="reviews">
                       <p>
                         ...
                         convenient as I could attend the course per my schedule. As I
                         am studying medicine in Germany my language knowledge came
                         handy. My tutor, Disha, was kind enough to make adjustments
                         many times so that I could easily recover whenever I missed a
                         session. I am definitely satisfied!”
                       </p>
                     </div>
                   </div>
                 </SwiperSlide>
                 <SwiperSlide>
                   <div className="swiper-slide">
                     <div className="profile-picture">
                       <img src="/Index/review - bhavana.png" alt="Bhawana Pawar HR" />
                     </div>
                     ...
                     <div className="reviews">
                       <p>
                         ...
                         improve their efficiency at work . We hope to work again with
                         Curiotory in future &nbsp;.”
                       </p>
                     </div>
                   </div>
