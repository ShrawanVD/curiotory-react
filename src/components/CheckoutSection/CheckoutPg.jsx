            ...
            <div className={pay.custom}>
              <div className={pay.card_body}>
                ...
                <p className={pay.card_text} style={{ padding: "0.5rem" }}>
                  <small style={{ fontSize: "11px", color: "#656565", textAlign: "left" }} className={pay.text_muted}>
                    You agree to share information entered on this page with Chalkboard Academy (owner of this page) & Razorpay, adhering to applicable laws.
                  </small>
                  <br />
                  <small style={{ fontSize: "11px", color: "#656565", textAlign: "left" }} className={pay.text_muted}>
                    <li>
