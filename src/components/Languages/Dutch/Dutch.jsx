...
function Dutch() {
  ...
  <div class="row">
    <div class="col sp-2">
      <img src="../images/Languages/dutch - 1.jpeg" alt="Language Learning" style="margin: 2rem 0" />
      <h3>From Beginner to Advanced Proficiency</h3>
      <p>
        Embark on an exciting journey to master Dutch, beginning with the
        essentials of vocabulary and grammar, then advancing steadily towards
        fluency and a profound cultural understanding.
      </p>
      <p>
        Start with foundational resources to build a solid base, then progress
    ...
    <div class="col sp-2">
      <img src="../images/Languages/dutch - 2.jpeg" alt="Certification Exams" style="margin: 2rem 0" />
      <h3>Certification Exams and Proficiency Levels</h3>
      <p>
        Validate your Dutch language skills with reputable exams such as the
        NT2 (Nederlands als Tweede Taal) or the CNaVT (Certificaat Nederlands
        als Vreemde Taal).
      </p>
      <p>
