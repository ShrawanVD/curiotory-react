  ...
  return (
    <div>
      ...
      <div className="row">
        <div className="col sp-2">
          ...
          <p>
            ...
            acumen. Begin your journey with basic greetings and essential
            phrases, then delve deeper into conversational skills and
            comprehension.
          </p>
          <p>
          ...
          <p>
            ...
            contemporary media, and engage in immersive experiences to refine
            your language skills and cultural understanding.
          </p>
        </div>
        <div className="col sp-2">
          <img
            src="/Languages/mandarin - 2.jpeg"
          ...
          <p>
            ...
            recognized exams such as the HSK (Hanyu Shuiping Kaoshi) or the
      ...
      <div className="banner">
        ...
        <p>
          Mastering Mandarin Chinese offers a gateway to a myriad of
          opportunities across diverse fields. In international business,
          fluency in Mandarin facilitates communication and negotiation with
          Chinese partners and clients, enhancing collaboration and driving
          success in global markets. In diplomacy, proficiency in Mandarin
          fosters mutual understanding and strengthens diplomatic ties between
          nations. Moreover, cultural enrichment and personal growth await those
          who immerse themselves in Mandarin-speaking communities, offering
          unique insights into the rich heritage and traditions of Chinese
          culture.
        </p>
      </div>
      <Footer />
