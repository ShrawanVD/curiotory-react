  ...
  return (
    <div>
      ...
      <div className="row">
        <div className="col sp-2">
          ...
          <p>
            ...
            through intermediate levels, honing your speaking, listening,
        ...
        <div className="col sp-2">
          <img
            src="/Languages/french - 2.jpeg"
            alt="Certification Exams"
            style={{ margin: "2rem 0" }}
          />
          <h3>Certification Exams and Proficiency Levels</h3>
          <p>
            Certify your French language skills with recognized exams such as
            DELF (Diplôme d Études en Langue Française) and DALF (Diplôme
            Approfondi de Langue Française).
          </p>
          <p>
            These exams assess proficiency levels ranging from A1 (Beginner) to
            C2 (Mastery), providing internationally recognized certification for
      ...
      <div className="banner">
        ...
        <p>
          Proficiency in French opens doors to international business,
          diplomacy, tourism, and cultural enrichment, offering opportunities in
